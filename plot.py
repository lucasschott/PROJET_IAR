...
if __name__ == "__main__":
    ...
    plt.figure()
    plt.plot(np.arange(len(conf_survivorships)),conf_survivorships,label="avec confusion")
    ...
    plt.plot(np.arange(len(no_conf_survivorships)),no_conf_survivorships,label="sans confusion")
    ...
    plt.figure()
    plt.plot(np.arange(len(conf_swarm_densitys)),conf_swarm_densitys,label="avec confusion")
    ...
    plt.plot(np.arange(len(no_conf_swarm_densitys)),no_conf_swarm_densitys,label="sans confusion")
    ...
    plt.figure()
    plt.plot(np.arange(len(conf_swarm_dispersions)),conf_swarm_dispersions,label="avec confusion")
    ...
    plt.plot(np.arange(len(no_conf_swarm_dispersions)),no_conf_swarm_dispersions,label="sans confusion")
