...
def plot(start=0,stop=10):
    ...
    plt.figure()
    plt.plot(np.arange(len(conf_survivorships_mean,)),conf_survivorships_mean,label="avec confusion")
    ...
    plt.plot(np.arange(len(no_conf_survivorships_mean)),no_conf_survivorships_mean,label="sans confusion")
    ...
    plt.figure()
    plt.plot(np.arange(len(conf_swarm_densitys_mean)),conf_swarm_densitys_mean,label="avec confusion")
    ...
    plt.plot(np.arange(len(no_conf_swarm_densitys_mean)),no_conf_swarm_densitys_mean,label="sans confusion")
    ...
    plt.figure()
    plt.plot(np.arange(len(conf_swarm_dispersions_mean)),conf_swarm_dispersions_mean,label="avec confusion")
    ...
    plt.plot(np.arange(len(no_conf_swarm_dispersions_mean)),no_conf_swarm_dispersions_mean,label="sans confusion")
